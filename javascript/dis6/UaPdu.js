...
null.UaPdu = function()
{
  ...
  null.UaPdu.prototype.initFromBinary = function(inputStream)
  {
       ...
       {
           var anX = new null.AcousticEmitterSystemData();
           anX.initFromBinary(inputStream);
  ...
  null.UaPdu.prototype.encodeToBinary = function(outputStream)
  {
