...
null.AggregateStatePdu = function()
{
   ...
   this.aggregateID = new null.EntityID(); 
   ...
   this.aggregateType = new null.EntityType(); 

   /** formation of aggregated entities */
   this.formation = 0;

   /** marking for aggregate; first char is charset type, rest is char data */
   this.aggregateMarking = new null.AggregateMarking(); 

   /** dimensions of bounding box for the aggregated entities, origin at the center of mass */
   this.dimensions = new null.Vector3Float(); 

   /** orientation of the bounding box */
   this.orientation = new null.Orientation(); 

   /** center of mass of the aggregation */
   this.centerOfMass = new null.Vector3Double(); 

   /** velocity of aggregation */
   this.velocity = new null.Vector3Float(); 
  ...
  null.AggregateStatePdu.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.AggregateStatePdu.prototype.encodeToBinary = function(outputStream)
  {
...
exports.AggregateStatePdu = null.AggregateStatePdu;
