...
null.EnvironmentalProcessPdu = function()
{
   ...
   this.environementalProcessID = new null.EntityID(); 

   /** Environment type */
   this.environmentType = new null.EntityType(); 
  ...
  null.EnvironmentalProcessPdu.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.EnvironmentalProcessPdu.prototype.encodeToBinary = function(outputStream)
  {
...
exports.EnvironmentalProcessPdu = null.EnvironmentalProcessPdu;
