...
null.AcousticEmitterSystemData = function()
{
   ...
   this.acousticEmitterSystem = new null.AcousticEmitterSystem(); 

   /** Represents the location wrt the entity */
   this.emitterLocation = new null.Vector3Float(); 
  ...
  null.AcousticEmitterSystemData.prototype.initFromBinary = function(inputStream)
  {
       ...
       {
           var anX = new null.AcousticBeamData();
  ...
  null.AcousticEmitterSystemData.prototype.encodeToBinary = function(outputStream)
  {
...
exports.AcousticEmitterSystemData = null.AcousticEmitterSystemData;
