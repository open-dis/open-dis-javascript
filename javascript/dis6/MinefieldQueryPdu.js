...
null.MinefieldQueryPdu = function()
{
   ...
   this.requestedMineType = new null.EntityType(); 
  ...
  null.MinefieldQueryPdu.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.MinefieldQueryPdu.prototype.encodeToBinary = function(outputStream)
  {
...
exports.MinefieldQueryPdu = null.MinefieldQueryPdu;
