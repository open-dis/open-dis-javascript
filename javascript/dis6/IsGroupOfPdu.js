...
null.IsGroupOfPdu = function()
{
   ...
   this.groupEntityID = new null.EntityID(); 
  ...
  null.IsGroupOfPdu.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.IsGroupOfPdu.prototype.encodeToBinary = function(outputStream)
  {
...
exports.IsGroupOfPdu = null.IsGroupOfPdu;
