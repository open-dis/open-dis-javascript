...
null.MinefieldDataPdu = function()
{
   ...
   /** Mine type */
   this.mineType = new null.EntityType(); 
  ...
  null.MinefieldDataPdu.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.MinefieldDataPdu.prototype.encodeToBinary = function(outputStream)
  {
...
exports.MinefieldDataPdu = null.MinefieldDataPdu;
