...
null.CollisionElasticPdu = function()
{
   ...
   this.issuingEntityID = new null.EntityID(); 

   /** ID of entity that has collided with the issuing entity ID */
   this.collidingEntityID = new null.EntityID(); 

   /** ID of event */
   this.collisionEventID = new null.EventID(); 

   /** some padding */
   this.pad = 0;

   /** velocity at collision */
   this.contactVelocity = new null.Vector3Float(); 
   ...
   this.unitSurfaceNormal = new null.Vector3Float(); 

   /** This field shall represent the degree to which energy is conserved in a collision */
   this.coefficientOfRestitution = 0;

  null.CollisionElasticPdu.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.CollisionElasticPdu.prototype.encodeToBinary = function(outputStream)
  {
...
exports.CollisionElasticPdu = null.CollisionElasticPdu;
