...
null.TrackJamTarget = function()
{
   /** track/jam target */
   this.trackJam = new null.EntityID(); 
  ...
  null.TrackJamTarget.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.TrackJamTarget.prototype.encodeToBinary = function(outputStream)
  {
...
exports.TrackJamTarget = null.TrackJamTarget;
