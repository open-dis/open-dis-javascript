...
null.FastEntityStatePdu.prototype.getPaintScheme = function()
{
...
/** 0 uniform color, 1 camouflage */
null.FastEntityStatePdu.prototype.setPaintScheme= function(val)
{
  var aVal = 0;
...
null.FastEntityStatePdu.prototype.getMobility = function()
{
...
/** 0 no mobility kill, 1 mobility kill */
null.FastEntityStatePdu.prototype.setMobility= function(val)
{
  var aVal = 0;
...
null.FastEntityStatePdu.prototype.getFirepower = function()
{
...
/** 0 no firepower iill, 1 firepower kill */
null.FastEntityStatePdu.prototype.setFirepower= function(val)
{
  var aVal = 0;
...
null.FastEntityStatePdu.prototype.getDamage = function()
{
...
/** 0 no damage, 1 slight damage, 2 moderate, 3 destroyed */
null.FastEntityStatePdu.prototype.setDamage= function(val)
{
  var aVal = 0;
...
null.FastEntityStatePdu.prototype.getSmoke = function()
{
...
/** 0 no smoke, 1 smoke plume, 2 engine smoke, 3 engine smoke and plume */
null.FastEntityStatePdu.prototype.setSmoke= function(val)
{
  var aVal = 0;
...
null.FastEntityStatePdu.prototype.getTrailingEffects = function()
{
...
/** dust cloud, 0 none 1 small 2 medium 3 large */
null.FastEntityStatePdu.prototype.setTrailingEffects= function(val)
{
  var aVal = 0;
...
null.FastEntityStatePdu.prototype.getHatch = function()
{
...
/** 0 NA 1 closed popped 3 popped and person visible  4 open 5 open and person visible */
null.FastEntityStatePdu.prototype.setHatch= function(val)
{
  var aVal = 0;
...
/** 0 off 1 on */
null.FastEntityStatePdu.prototype.getHeadlights = function()
{
...
/** 0 off 1 on */
null.FastEntityStatePdu.prototype.setHeadlights= function(val)
{
  var aVal = 0;
...
/** 0 off 1 on */
null.FastEntityStatePdu.prototype.getTailLights = function()
{
...
/** 0 off 1 on */
null.FastEntityStatePdu.prototype.setTailLights= function(val)
{
  var aVal = 0;
...
/** 0 off 1 on */
null.FastEntityStatePdu.prototype.getBrakeLights = function()
{
...
/** 0 off 1 on */
null.FastEntityStatePdu.prototype.setBrakeLights= function(val)
{
  var aVal = 0;
...
/** 0 off 1 on */
null.FastEntityStatePdu.prototype.getFlaming = function()
{
...
/** 0 off 1 on */
null.FastEntityStatePdu.prototype.setFlaming= function(val)
{
  var aVal = 0;
...
null.FastEntityStatePdu.prototype.getLauncher = function()
{
...
/** 0 not raised 1 raised */
null.FastEntityStatePdu.prototype.setLauncher= function(val)
{
  var aVal = 0;
...
null.FastEntityStatePdu.prototype.getCamouflageType = function()
{
...
/** 0 desert 1 winter 2 forest 3 unused */
null.FastEntityStatePdu.prototype.setCamouflageType= function(val)
{
  var aVal = 0;
