...
null.GriddedDataPdu = function()
{
   ...
   this.environmentalSimulationApplicationID = new null.EntityID(); 
  ...
  null.GriddedDataPdu.prototype.initFromBinary = function(inputStream)
  {
       ...
       {
           var anX = new null.GridAxisRecord();
  ...
  null.GriddedDataPdu.prototype.encodeToBinary = function(outputStream)
  {
...
exports.GriddedDataPdu = null.GriddedDataPdu;
