...
null.IffAtcNavAidsLayer2Pdu = function()
{
   ...
   this.systemID = new null.SystemID(); 

   /** padding */
   this.pad2 = 0;

   /** fundamental parameters */
   this.fundamentalParameters = new null.IffFundamentalData(); 

   /** layer header */
   this.layerHeader = new null.LayerHeader(); 

   /** beam data */
   this.beamData = new null.BeamData(); 

   /** Secondary operational data, 5.2.57 */
   this.secondaryOperationalData = new null.BeamData(); 

   /** variable length list of fundamental parameters. ^^^This is wrong */
    this.fundamentalIffParameters = new Array();
 
  null.IffAtcNavAidsLayer2Pdu.prototype.initFromBinary = function(inputStream)
  {
       ...
       {
           var anX = new null.FundamentalParameterDataIff();
  ...
  null.IffAtcNavAidsLayer2Pdu.prototype.encodeToBinary = function(outputStream)
  {
...
exports.IffAtcNavAidsLayer2Pdu = null.IffAtcNavAidsLayer2Pdu;
