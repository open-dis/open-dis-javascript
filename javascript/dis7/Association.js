...
null.Association = function()
{
   ...
   this.associatedEntityID = new null.EntityID(); 

   /** location, in world coordinates */
   this.associatedLocation = new null.Vector3Double(); 

  null.Association.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.Association.prototype.encodeToBinary = function(outputStream)
  {
...
exports.Association = null.Association;
