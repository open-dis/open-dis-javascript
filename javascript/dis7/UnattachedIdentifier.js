...
null.UnattachedIdentifier = function()
{
   /** See 6.2.79 */
  ...
  null.UnattachedIdentifier.prototype.initFromBinary = function(inputStream)
  {
       this.simulationAddress.initFromBinary(inputStream);
       this.referenceNumber = inputStream.readUShort();
  };

  null.UnattachedIdentifier.prototype.encodeToBinary = function(outputStream)
  {
...
exports.UnattachedIdentifier = null.UnattachedIdentifier;
