...
null.EntityIdentifier = function()
{
  ...
  null.EntityIdentifier.prototype.initFromBinary = function(inputStream)
  {
       this.simulationAddress.initFromBinary(inputStream);
       this.entityNumber = inputStream.readUShort();
  };

  null.EntityIdentifier.prototype.encodeToBinary = function(outputStream)
  {
...
exports.EntityIdentifier = null.EntityIdentifier;
