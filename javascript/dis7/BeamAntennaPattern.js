...
null.BeamAntennaPattern = function()
{
   ...
   this.beamDirection = new null.EulerAngles(); 
  ...
  null.BeamAntennaPattern.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.BeamAntennaPattern.prototype.encodeToBinary = function(outputStream)
  {
...
exports.BeamAntennaPattern = null.BeamAntennaPattern;
