...
null.Environment = function()
{
  ...
  null.Environment.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.Environment.prototype.encodeToBinary = function(outputStream)
  {
...
exports.Environment = null.Environment;
