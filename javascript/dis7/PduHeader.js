...
null.PduHeader = function()
{
  ...
  null.PduHeader.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.PduHeader.prototype.encodeToBinary = function(outputStream)
  {
...
exports.PduHeader = null.PduHeader;
