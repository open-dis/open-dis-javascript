...
null.PduStream = function()
{
  ...
  null.PduStream.prototype.initFromBinary = function(inputStream)
  {
  ...
  null.PduStream.prototype.encodeToBinary = function(outputStream)
  {
       for(var idx = 0; idx < 512; idx++)
       {
...
exports.PduStream = null.PduStream;
